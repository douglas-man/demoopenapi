...
public class MemberController {
    ...
    @ApiResponses(
            value = {
                    ...
                    @ApiResponse(
                            responseCode = "409",
                            description = "Member alreadly exists",
                            content = @Content(
                                    schema = @Schema(implementation = ErrorObject.class)
    ...
    @PostMapping(consumes = "application/json", produces = "applicaiton/json")
    ...
    @PutMapping(consumes = "application/json", produces = "applicaiton/json")
